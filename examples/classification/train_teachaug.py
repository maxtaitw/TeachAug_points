...
from openpoints.function_adaptpoint import Form_dataset_cls, get_feedback_loss_ver1, get_feedback_loss_teacher
...
def train_gan(cfg, gan_dict, train_loader, summary, writer, epoch, model_pointcloud, model_teacher):
    ...
    for i, data in tqdm(enumerate(train_loader), total=train_loader.__len__()):
        ...
        if feedback_loss_ratio > 0:
            feedback_loss = get_feedback_loss_teacher(cfg=cfg, model_pointcloud=model_pointcloud, model_teacher=model_teacher, \
